...
class User_level_model extends CI_Model {
    ...
    function json() {
        ...
        $this->datatables->add_column('action', anchor(site_url('userlevel/akses/$1'), '<i class="fa fa-level-up " aria-hidden="true"> beri akses</i>', array('class' => 'btn btn-danger btn-sm')) . " 
            " . anchor(site_url('userlevel/update/$1'), '<i class="fa fa-pencil-square-o" aria-hidden="true"> edit</i>', array('class' => 'btn btn-danger btn-sm')) . " 
            " . anchor(site_url('userlevel/delete/$1'), '<i class="fa fa-trash-o" aria-hidden="true"> hapus</i>', 'class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are You Sure ?\')"'), 'id_user_level');
