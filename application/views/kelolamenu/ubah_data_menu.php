                ...
                <div class="table-responsive"> 
                    <table class='table table-bordered'>        
                       <tr>
                        ...
                        <tr>
                            <td width='200'>Is Main Menu <?php echo form_error('is_main_menu') ?></td><td>          
                            <select id="is_main_menu" name="is_main_menu" class="form-control">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo form_dropdown('is_aktif', array('Aktif' => 'Aktif', 'Tidak Aktif' => 'Tidak Aktif'), $is_aktif, array('class' => 'form-control select2')) ?>
                            </td>
                        </tr>
                        <tr>
                            <td></td>
