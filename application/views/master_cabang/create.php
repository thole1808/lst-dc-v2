		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		                ...
		                placeholder="Masukan Nama Cabang" value="<?php echo $nama_cabang; ?>" /> 
		                <script type="text/javascript">
		                    document.getElementById('nama_cabang').value = "<?php echo $_POST['nama_cabang'];?>";
		                </script>
		          ...
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('master_cabang') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
	...
	// wait untill the page is loaded completely
        ...
        // include the validation for the form function comes with this plugin
            ...
            // set validation messages for the rules are set previously
                messages: {
                    nama_cabang: {
                        required : "Nama Cabang Wajib di isi",
