            ...
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">List Sub Urgency Insiden</h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php echo anchor(site_url('sub_urgency_insiden/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Sub Urgency Insiden', 'class="btn btn-danger btn-sm"'); ?>       
                        </div>
                        <br>
                        <!-- Style-->
                        <style type="text/css">
...
$(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "sub_urgency_insiden/json", "type": "POST"},
        columns: [
            {
                "data": "id_sub_urgency_insiden",
                "orderable": false
            },
                {"data": "nama_dampak"},
                {"data": "nama_urgency"},
