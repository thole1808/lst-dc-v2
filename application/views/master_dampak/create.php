    ...
    <section class="content">
    	<div class="box-body">
    		...
    		<div class="box box-primary box-solid">
		          ...
		          <h3 class="box-title">Input Data Dampak</h3>
		      	</div>
		      	<style type="text/css">
		      		.error {
			            color: #a94442;
		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		                <label>Nama Dampak</label>
		                <input type="text" class="form-control" name="nama_dampak" id="nama_dampak" 
		                placeholder="Masukan Nama Dampak" value="<?php echo $nama_dampak; ?>" /> 
		                <script type="text/javascript">
		                    document.getElementById('nama_dampak').value = "<?php echo $_POST['nama_dampak'];?>";
		                </script>
		            </div>
		          </div>
		          <!-- button -->
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('master_dampak') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
		             <input type="hidden" name="id_dampak" value="<?php echo $id_dampak; ?>" />
		          </div>
		          <!-- button -->
		        </div>
		      	</form>
...
// include the validation for the form function comes with this plugin
    ...
    // set validation messages for the rules are set previously
        messages: {
            nama_dampak: {
                required : "Nama Dampak Wajib di isi",
