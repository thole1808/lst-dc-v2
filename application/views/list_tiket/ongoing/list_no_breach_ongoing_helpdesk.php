    ...
    <div class="box-body">
      ...
      <div class="box box-primary box-solid">
          <div class="box-header">
              <h3 class="box-title">List Tiket Ongoing No Breach</h3>
          </div>
          <div class="box-body">
                   ...
                   <!-- Menghitung Waktu Berjalan -->
                    ...
                    <?php
                      if(!empty($list_tiket_ongoing)){ 
                        ...
                        <!-- Prioritas 5 Tidak ada karena Waktu penanganan Tidak ada -->
                        <?php if($data->nama_prioritas=='Prioritas 5'){?>
                        ...
                        <?php }elseif ($data->waktu_penanganan >= waktu_lalu($data->tgl_dibuat)){ ?>
                          <tr>
                            ...
                            <!-- kirim kembali tiket yang salah-->
