    ...
    <section class="content">
    	<div class="box-body">
    		...
    		<div class="box box-primary box-solid">
		          ...
		          <h3 class="box-title">Input Sub Status Jenis Tiket</h3>
		      	</div>
		      	<style type="text/css">
		      		.error {
			            color: #a94442;
		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		          	...
		          	<div class='col-md-12 form-group'>
		                <label>Status</label>
		                <?php echo cmb_dinamis ('id_status_tiket', 'master_status_tiket', 'nama_status', 'id_status_tiket', 
		                $id_status_tiket) ?>  
		                <script type="text/javascript">
		          ...
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('sub_status_jenis_tiket') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
		             <input type="hidden" name="id_sub_status_jenis_tiket" value="<?php echo $id_sub_status_jenis_tiket; ?>" />
		          </div>
		          <!-- button -->
		        </div>
		      	</form>
  	...
  	$(function(){
	    $("select[name='id_jenis_tiket']").select2({
            ...
            language: {
	      	...
	      	ajax: { 
	         url: '<?php echo  base_url() ?>index.php/Sub_status_jenis_tiket/cari_jenis_tiket',
	         type: "POST",
	         dataType: 'json',
	         delay: 250,
	    ...
	    $("select[name='id_status_tiket']").select2({
            ...
            language: {
	      	...
	      	ajax: { 
	         url: '<?php echo  base_url() ?>index.php/Sub_status_jenis_tiket/cari_status_tiket',
	         type: "POST",
	         dataType: 'json',
	         delay: 250,
	         data: function (params) {
