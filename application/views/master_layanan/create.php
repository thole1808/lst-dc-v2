		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		                ...
		                placeholder="Masukan Nama Layanan" value="<?php echo $nama_layanan; ?>" /> 
		                <script type="text/javascript">
		                    document.getElementById('nama_layanan').value = "<?php echo $_POST['nama_layanan'];?>";
		                </script>
		          ...
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('master_layanan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
		             <input type="hidden" name="id_layanan" value="<?php echo $id_jabatan; ?>" />
		          </div>
		          <!-- button -->
		        </div>
		      	</form>
	...
	// wait untill the page is loaded completely
        ...
        // include the validation for the form function comes with this plugin
            ...
            // set validation messages for the rules are set previously
                messages: {
                    nama_layanan: {
                        required : "Nama Layanan Wajib di isi",
