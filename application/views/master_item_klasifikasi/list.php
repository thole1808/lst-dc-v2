            ...
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">List Data Item Klasifikasi</h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php echo anchor(site_url('master_item_klasifikasi/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Item Klasifikasi', 'class="btn btn-danger btn-sm"'); ?>       
                        </div>
                        <br>
                        <!-- Style-->
                        <style type="text/css">
...
$(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "master_item_klasifikasi/json", "type": "POST"},
        columns: [
            {
                "data": "id_item_klasifikasi",
                "orderable": false
            },
                {"data": "nama_item_klasifikasi"},
                {"data": "dibuat_oleh"},
                {"data": "diubah_oleh"},
