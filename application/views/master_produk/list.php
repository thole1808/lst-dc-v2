                ...
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php echo anchor(site_url('master_produk/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Produk', 'class="btn btn-danger btn-sm"'); ?>       
                        </div>
                        <br>
                        <!-- Style-->
                        <style type="text/css">
...
$(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "master_produk/json", "type": "POST"},
        columns: [
            {
                "data": "id_produk",
                "orderable": false
