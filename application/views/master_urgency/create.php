    ...
    <section class="content">
    	<div class="box-body">
    		...
    		<div class="box box-primary box-solid">
		          ...
		          <h3 class="box-title">Input Data Urgency</h3>
		      	</div>
		      	<style type="text/css">
		      		.error {
			            color: #a94442;
		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		                <label>Nama Urgency</label>
		                <input type="text" class="form-control" name="nama_urgency" id="nama_urgency" 
		                placeholder="Masukan Nama Urgency" value="<?php echo $nama_urgency; ?>" /> 
		                <script type="text/javascript">
		                    document.getElementById('nama_urgency').value = "<?php echo $_POST['nama_urgency'];?>";
		                </script>
		          ...
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('master_urgency') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
		             <input type="hidden" name="id_urgency" value="<?php echo $id_urgency; ?>" />
		          </div>
		          <!-- button -->
		        </div>
		      	</form>
	...
	// wait untill the page is loaded completely
        ...
        // include the validation for the form function comes with this plugin
            ...
            // set validation messages for the rules are set previously
                messages: {
                    nama_urgency: {
                        required : "Nama Urgency Wajib di isi",
