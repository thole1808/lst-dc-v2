                ...
                <div class="box box-primary box-solid">
                    ...
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php echo anchor(site_url('sub_admin_klien/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Sub Admin Klien', 'class="btn btn-danger btn-sm"'); ?>       
                        </div>
                        <br>
                        <!-- Style-->
                        <style type="text/css">
...
$(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "sub_admin_klien/json", "type": "POST"},
        columns: [
            {
                "data": "id_sub_admin_klien",
                "orderable": false
            },
                {"data": "nama_klien"},
                {"data": "nama_admin"},
