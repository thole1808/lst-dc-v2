    ...
    <section class="content">
    	<div class="box-body">
    		...
    		<div class="box box-primary box-solid">
		          ...
		          <h3 class="box-title">Input Data Klien</h3>
		      	</div>
		      	<style type="text/css">
		      		.error {
			            color: #a94442;
		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		                ...
		                placeholder="Masukan Nama Klien" value="<?php echo $nama_klien; ?>" /> 
		                <script type="text/javascript">
		                    document.getElementById('nama_klien').value = "<?php echo $_POST['nama_klien'];?>";
		                </script>
		          ...
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('master_klien') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
	...
	// wait untill the page is loaded completely
        ...
        // include the validation for the form function comes with this plugin
            ...
            // set validation messages for the rules are set previously
                messages: {
                    nama_klien: {
                        required : "Nama Klien Wajib di isi",
