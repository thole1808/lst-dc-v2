    		...
    		<div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">List Data Klien</h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php echo anchor(site_url('master_klien/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Klien', 'class="btn btn-danger btn-sm"'); ?>       
                        </div>
                        <br>
                        <!-- Style-->
                        <style type="text/css">
...
$(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "master_klien/json", "type": "POST"},
        columns: [
            {
                "data": "id_klien",
                "orderable": false
