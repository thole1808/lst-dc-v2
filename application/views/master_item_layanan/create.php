    ...
    <section class="content">
    	<div class="box-body">
    		...
    		<div class="box box-primary box-solid">
		          ...
		          <h3 class="box-title">Input Data Item Layanan</h3>
		      	</div>
		      	<style type="text/css">
		      		.error {
			            color: #a94442;
		        ...
		        <div class="box-body">
		          <div class="row">
		            <div class='col-md-12 form-group'>
		                ...
		                <input type="text" class="form-control" name="nama_item_layanan" id="nama_item_layanan" 
		                placeholder="Masukan Nama Item Layanan" value="<?php echo $nama_item_layanan; ?>" /> 
		                <script type="text/javascript">
		                    document.getElementById('nama_item_layanan').value = "<?php echo $_POST['nama_item_layanan'];?>";
		                </script>
		          ...
		          <div class="col-sm-6 form-group">
		              ...
		              <a href="<?php echo site_url('master_item_layanan') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a>
		             <input type="hidden" name="id_item_layanan" value="<?php echo $id_item_layanan; ?>" />
		          </div>
		          <!-- button -->
		        </div>
		      	</form>
	...
	// wait untill the page is loaded completely
        ...
        // include the validation for the form function comes with this plugin
            ...
            // set validation messages for the rules are set previously
                messages: {
                    nama_item_layanan: {
                        required : "Nama Item Layanan Wajib di isi",
