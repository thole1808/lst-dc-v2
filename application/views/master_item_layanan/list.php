            ...
            <div class="col-xs-12">
                <div class="box box-primary box-solid">
                    <div class="box-header">
                        <h3 class="box-title">List Data Item Layanan</h3>
                    </div>
                    <div class="box-body">
                        <div style="padding-bottom: 10px;">
                            <?php echo anchor(site_url('master_item_layanan/create'), '<i class="fa fa-plus" aria-hidden="true"></i> Tambah Item Layanan', 'class="btn btn-danger btn-sm"'); ?>       
                        </div>
                        <br>
                        <!-- Style-->
                        <style type="text/css">
...
$(document).ready(function() {
    ...
    var t = $("#mytable").dataTable({
        ...
        processing: true,
        serverSide: true,
        ajax: {"url": "master_item_layanan/json", "type": "POST"},
        columns: [
            {
                "data": "id_item_layanan",
                "orderable": false
            },
                {"data": "nama_item_layanan"},
                {"data": "dibuat_oleh"},
                {"data": "diubah_oleh"},
