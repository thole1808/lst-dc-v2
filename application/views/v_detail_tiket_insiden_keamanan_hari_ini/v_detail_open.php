...
<div class="box-header with-border">
    ...
    <h3 class="box-title"> Tiket Insiden Keamanan Informasi Open Hari InI</h3>              
</div>
<!-- Style-->
<style type="text/css">
    #table {
...
<div id="table" class="table-responsive">
  <table class="table table-bordered table-striped" id="mytable">
      ...
      <tbody>
          ...
          <!-- Menghitung Waktu Berjalan -->
          <?php
            if(!empty($cek_tiket_insiden_keamanan_open)){ 
              $no = 1;
              foreach ($cek_tiket_insiden_keamanan_open as $data){
              ?>
              <!-- Prioritas 1 Red -->
