...
<div class="box-header with-border">
    ...
    <h3 class="box-title"> Tiket Insiden Keamanan Informasi CLosed Hari InI</h3>              
</div>
<!-- Style-->
<style type="text/css">
    #table {
...
<div id="table" class="table-responsive">
  <table class="table table-bordered table-striped" id="mytable">
      ...
      <tbody>
          <?php
            if(!empty($cek_tiket_insiden_keamanan_closed)){ 
              $no = 1;
              foreach ($cek_tiket_insiden_keamanan_closed as $data){                         
              ?>
              <!-- Prioritas 1 Red -->
