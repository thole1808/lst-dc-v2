        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
            <div class="table-responsive">
                <table class='table table-bordered'> 
                    <tr>
                        <td width='200'>Nama Lengkap <?php echo form_error('full_name') ?></td><td><input type="text" class="form-control" name="full_name" id="full_name" placeholder="Full Name" value="<?php echo $full_name; ?>" />
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo form_dropdown('is_aktif', array('Aktif' => 'Aktif', 'Tidak Aktif' => 'Tidak Aktif'), $is_aktif, array('class' => 'form-control')); ?>  
                        </td>
                    </tr>
                    <tr>
