...
class Send_email extends CI_Controller {
    ...
    {
      // Konfigurasi email
        $from_email = "achmadagushadiyanto18@gmail.com"; 
        $config = [
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'protocol'  => 'smtp',
            ...
            'smtp_pass'   => 'toleganteng',  // Password gmail
            'smtp_crypto' => 'ssl',
            'smtp_port'   => 465,
            'crlf'    => "\r\n",
            'newline' => "\r\n"
        ...
        $this->email->from('achmadagushadiyanto18@gmail.com', 'MasRud.com');

        // Email penerima
        $this->email->to('achmadagushadiyanto18@gmail.com'); // Ganti dengan email tujuan
