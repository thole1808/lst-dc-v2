...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>LST-DC - Service Desk</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, shrink-to-fit=no" />
    <link rel="apple-touch-icon" href="<?php echo base_url('assets/img/login/logo_lst.png')?>">
    <link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url('assets/img/login/logo_lst.png')?>">
    <link rel="apple-touch-icon" sizes="120x120" href="<?php echo base_url('assets/img/login/logo_lst.png')?>">
    <link rel="apple-touch-icon" sizes="152x152" href="<?php echo base_url('assets/img/login/logo_lst.png')?>">
    <link rel="icon" type="image/x-icon" href="<?php echo base_url('assets/img/login/logo_lst.png')?>" />
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown pull-right hidden-md-down">
            ...
            <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
              ...
              <a href="<?=site_url('auth/logout')?>" class="clearfix bg-master-lighter dropdown-item">
