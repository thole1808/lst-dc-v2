...
<html>
  <head>
    ...
    <meta charset="utf-8" />
    <title>LST-Payroll - @yield('title')</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no, shrink-to-fit=no" />
    <link rel="apple-touch-icon" href="{{asset('assets/img/login/logo_lst.png')}}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{asset('assets/img/login/logo_lst.png')}}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{asset('assets/img/login/logo_lst.png')}}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{asset('assets/img/login/logo_lst.png')}}">
    <link rel="icon" type="image/x-icon" href="{{asset('assets/img/login/logo_lst.png')}}" />
                      ...
                      <div class="notification-item unread clearfix">
                        <div class="heading">
                          <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                            <img width="30" height="30" data-src-retina="{{asset('assets/img/profiles/1x.jpg')}}" data-src="{{asset('assets/img/profiles/1.jpg')}}" alt="" src="assets/img/profiles/1.jpg">
                          </div>
                          <a href="#" class="text-primary pull-left">
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" alt="" data-src-retina="{{asset('assets/img/profiles/1x.jpg')}}" data-src="{{asset('assets/img/profiles/1x.jpg')}}" src="{{asset('assets/img/profiles/1x.jpg')}}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
                ...
                <div class="list-view-group-container">
                  ...
                  <ul>
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                          {{asset('assets/img/profiles/3x.jpg')}}
                            <img width="34" height="34" alt="" data-src-retina="{{asset('assets/img/profiles/4x.jpg')}}" data-src="{{asset('assets/img/profiles/4.jpg')}}" src="assets/img/profiles/4x.jpg" class="col-top">
                        </span>
                        <p class="p-l-10 ">
